   ...
   <section class="row">
	<section class="col s12 m6 push-m3">
		...
		<table class="stripped">
			...
			<tbody>
				<!-- Efetuar listagem dos dados do banco de dados-->
             <?php 
              ...
              ?>
				...
				<tr>
					...
					<!--Botão excluir-->
					<td>
						<a  href="#modal1 <?php echo $dados['id'];?>"  class="btn-floating waves-effect waves-light modal-trigger red"><i class="material-icons">delete</i></a>
						  <!-- Modal Structure -->
						<div id="modal1 <?php echo $dados['id'];?>" class="modal">
						  <div class="modal-content">
						   ...
						   <div class="modal-footer">
						     ...
						     <button type="submit" name="btn-deletar" class="btn red modal-class waves-effect waves-green btn-flat">Sim</button>
